...
class Everything(db.Model):
    ...
    AxisX_min = db.Column('axix_min', db.String, nullable=True)
    AxisX_max = db.Column('axix_max', db.String, nullable=True)
    AxisY = db.Column("axisy", db.String, nullable=True)
    Geometric_shape = db.Column("geometric_shape", db.String, nullable=True)
